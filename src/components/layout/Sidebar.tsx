...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[280px] h-screen fixed top-0 start-0 bg-bg-secondary border-e border-border-subtle z-40">
      <div className="h-16 flex items-center px-6 border-b border-border-subtle shrink-0">
        <Link href={"/dashboard" as Route} className="text-2xl font-bold text-primary-500">
          يَعَل
        </Link>
      </div>
